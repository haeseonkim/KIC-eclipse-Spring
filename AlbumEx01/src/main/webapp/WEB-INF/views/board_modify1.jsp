...
<div class="contents1"> 
	...
	<form action="modify_ok.do?cpage=<%=cpage %>" method="post" name="mfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			...
			<div class="btn_area">
				<div class="align_left">			
					...
					<input type="button" value="보가" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='view.do?cpage=<%=cpage %>&seq=<%=seq %>'" />
				</div>
